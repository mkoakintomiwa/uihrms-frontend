...
import httpServerGetRequest from '../lib/server/httpGetRequest'
...
import accessToken from '../lib/server/accessToken'
    ...
    useEffect(function(){
            ...
            //pageApiData().then(pageData=>{
                ...
                setFormState(prev=>{
                    let newState = setFormStateDefinedValues({
                        ...userData,
                        passport: datauriToFile(props.passport.datauri,"passport"),
                    }, prev)
                    ...
                    newState = {
                        ...
                        passport: {
                            ...newState.passport,
                            placeholder: props.passport.datauri
                        }
                    }
...
export async function getServerSideProps({ query, req }: any){
    ...
    let userData = (await httpServerGetRequest(`${api}/user`,token)).data;
     
    let passport = (await httpServerGetRequest(`${api}/user-passport-datauri`, token,{
