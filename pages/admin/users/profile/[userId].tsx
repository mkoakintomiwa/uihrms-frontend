					...
					{ !pageIsLoading?(
                        <WhiteBox style={{ width: "500px" }}>  
                            ...
                            <SpaceBetween>
                                ...
                                <Button color='error' sx={{ fontSize: "14px" }} onClick={e=>{
                                    Swal.fire({
                                        title: 'Are you sure?',
                                        ...
                                        if (result.isConfirmed) {
                                            ...
                                            httpPostRequest(`${api}/delete-user-account`,{
                                                user_id: userId
                                            }).then(response=>{
                                                const { data } = response;
                                                ...
                                                if (!data.error){
                                                    Swal.fire({
                                                        html: <div>Account successfully deleted</div>,
                                                        icon: "success"
                                                    });
                                                    router.push("/users");
                                                }else{
                            ...
                            <Box id="add-user-form" component="form" sx={{ marginTop: "30px" }}>
                                ...
                                <DialogActions>
                                    ...
                                    <Button disabled={ changePasswordIsLoading } onClick={e=>{
                                        ...
                                        if (isValidated){
                                            ...
                                            httpPostRequest(`${api}/update-user-password`,{
                                                user_id: userId,
                            ...
                            <Fab sx={{ position: "fixed", bottom: "50px", right: "50px", backgroundColor: themeColor, color: "white", '&:hover': {
                                ...
                                if (!isSaving){
                                    ...
                                    if (validation.isValidated){
                                        ...
                                        httpPostRequest(`${api}/update-user-profile`, Object.assign({ user_id: userId },formStateValuesToJson(formState))).then(response=>{
